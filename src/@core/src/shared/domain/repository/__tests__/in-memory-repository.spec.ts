...
describe('InMemoryRepository Unit Tests', () => {
    ...
    it('should throws error when entity not found', async () => {
        expect(repository.findById('fake uid')).rejects.toThrow(
            new NotFoundError('Entity not found using ID: fake uid'),
        );

        expect(repository.findById('829137b2-bce5-4651-aa75-20da6548b8f3')).rejects.toThrow(
    ...
    it('should throws error in delete when entity not found', async () => {
        ...
        expect(repository.delete('829137b2-bce5-4651-aa75-20da6548b8f3')).rejects.toThrow(
            new NotFoundError('Entity not found using ID: 829137b2-bce5-4651-aa75-20da6548b8f3'),
        );
    });
